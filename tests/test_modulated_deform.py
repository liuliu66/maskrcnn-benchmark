...
from maskrcnn_benchmark.csrc.dcn_src import ModulatedDeformConvPack
from maskrcnn_benchmark.csrc.dcn_src import DeformRoIPooling
from maskrcnn_benchmark.csrc.dcn_src import ModulatedDeformRoIPoolingPack
...
def example_dconv():
    from maskrcnn_benchmark.csrc.dcn_src import ModulatedDeformConv
    input = torch.randn(2, 64, 128, 128).cuda()
    # wrap all things (offset and mask) in DCN
    dcn = ModulatedDeformConvPack(64, 64, kernel_size=(3,3), stride=1, padding=1, deformable_groups=2, bias=False).cuda()
    output = dcn(input)
